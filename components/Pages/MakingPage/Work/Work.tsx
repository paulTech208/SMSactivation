...
const Work = () => (
  <FadeInWhenVisible className="py-5 mt-[100px]">
    ...
    <FadeInWhenVisible className="w-[300px] 3md:w-[600px] xl:w-full flex flex-col mt-[30px]">
      <p
        className="font-space_grotesk font-500 text-2xl 3md:text-3xl md:text-4xl mb-4 mb-[70px]
                    text-white text-center md:text-left"
      >
        2 simple steps to start earning:
      </p>

      <div className="grid grid-cols-1 md:grid-cols-3">
        <div className="col-span-1 m-auto">
          <Media
            link="/images/making/iPhone-Mockup.svg"
            blurLink="/images/making/iPhone-Mockup.png"
            containerClasses="w-[192px] 3md:w-[150px] lg:w-[192px] aspect-[192/389] rounded-full mb-[50px]"
          />
        </div>
